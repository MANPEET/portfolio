...
const Footer = () => {
  return (
    <footer className="border-t mx-10 py-10 lg:flex justify-between items-center text-[#262729]">
      <div>
        <p className="text-lg font-semibold">Manpreet</p>
        <p className="text-sm text-gray-500">contact@Manpreet.com</p>
      </div>

      <div className="flex gap-6 uppercase text-sm mt-6 lg:mt-0">
        <a href="#"><FaGithub className="inline mr-2" /> Github</a>
